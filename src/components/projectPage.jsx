    ...
    <div style={{ animation: "projectFadeIn 0.3s ease both" }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          aspectRatio: "4/3", background: "#f4efe7",
      ...
      <div style={{ background: "linear-gradient(160deg, #5D4480 0%, #8B6BAE 40%, #B8709C 70%, #D4849A 100%)" }}>
        <div className="max-w-[1100px] mx-auto px-8 py-4 mb-6 flex items-center">
          <div className="flex flex-col gap-2">
            <span className="font-mono text-xs uppercase tracking-[0.18em] text-white/75">Things I've Built</span>
            <h1 className="font-heading italic font-semibold text-5xl text-white leading-tight m-0 py-2">Projects</h1>
          </div>
        </div>
      </div>
